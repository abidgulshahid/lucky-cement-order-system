...
from .views import (Contact_US, HomeView, ItemDetailView, about_us, add_to_cart, remove_from_the_cart, OrderSummary,
                    ...
                    SSLPayment, complete, complete_payment, career)
