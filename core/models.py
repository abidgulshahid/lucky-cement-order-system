...
class cash_on_delivery(models.Model):
    ...
    no_of_items =  models.CharField(max_length=100 ,null=True, blank=True)
    amounts = models.CharField(max_length=100,null=True, blank=True)
    orders  =models.ForeignKey(Cart, on_delete=models.CASCADE, default="0")
...
def generate_code(size=22, chars=string.ascii_lowercase):
